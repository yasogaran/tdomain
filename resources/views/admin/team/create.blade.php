<x-admin-layout>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-text-main mb-2">Add Team Member</h1>
                <p class="text-text-main/60">Create a new team member profile</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="bio"
                              ...
                              class="w-full px-4 py-3 bg-primary-bg border border-text-main/10 rounded-lg text-text-main focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent">{{ old('bio') }}</textarea>
                    @error('bio')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
